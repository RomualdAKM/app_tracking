                            ...
                            <div class="box box--stacked flex flex-col p-1.5">
                                <div
                                    ...
                                    <div class="absolute inset-x-0 top-0 mx-auto mt-36 h-32 w-32">
                                        <div v-if="user.company"
                                            ...
                                            <img :src="'/logo_company/' + user.company.logo_company"
                                ...
                                <!-- <div class="flex flex-col gap-y-3 rounded-[0.6rem] bg-slate-50 p-5 pt-12 sm:flex-row sm:items-end">
                                                <div v-if="user.company">
                                                    ...
                                                    <label class="mb-2 group-[.form-inline]:mb-2 group-[.form-inline]:sm:mb-0 group-[.form-inline]:sm:mr-5 group-[.form-inline]:sm:text-right flex items-center text-slate-500">
                                                      user
                                                    </label>
