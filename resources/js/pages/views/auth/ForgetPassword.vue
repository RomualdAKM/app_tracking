<template>
    <!-- BEGIN: Modal Content -->
    <div data-tw-backdrop="" aria-hidden="true" tabindex="-1" id="forget-password-modal-preview"
        ...
        <div  data-tw-merge
            ...
            <div v-if="successMessage" class="px-5 py-3 mt-3 mr-auto text-base font-medium text-center border-t border-slate-200/60 dark:border-darkmode-400">
                <h2>Verifier votre Email</h2>
            </div>
            ...
            <div v-else>
                ...
                <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-12">
                        ...
                        <input data-tw-merge id="modal-form-2" v-model="form.email" type="text"
                            placeholder=" Email"
            ...
            <div class="px-5 py-3 text-right border-t border-slate-200/60 dark:border-darkmode-400">
                ...
                <div v-else>
                    ...
                    <button @click="getNewPassword()" type="button" v-if="successMessage == false"
...
const getNewPassword = async () => {
    isLoading.value = true; // Activation du chargement
        ...
        await axios.post("/api/forgot_password", form.value).then((response)=>{
            if(response.data.success){
                ...
                toast.fire({
                    icon: "error",
                    title: 'Aucun utilisateur trouvé avec cet email.',
             });
